...
const RepeatCustomerGraph = () => {
  return (
    <div>
      <Card className='bg-slate-100'>
        <CardHeader>
          <CardTitle>Average spent by repeat customers</CardTitle>
          <h1 className='font-bold text-2xl ml-2 mb-1 mt-4'>19%</h1>
          <h2>Less spend on every order by repeat customers</h2>
        </CardHeader>
        <CardContent>
...
export default RepeatCustomerGraph
